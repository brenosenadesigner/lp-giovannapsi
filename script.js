  ...
  if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
    ...
    if (tripticoSection && cards.length === 3) {
      ...
      mm.add({
        ...
        cards.forEach((card, index) => {
          ...
          if (isDesktop) {
            ...
            gsap.set(card, {
              ...
              scale: isFirst ? 1 : (index === 1 ? 0.96 : 0.92),
              xPercent: 0,
              yPercent: isFirst ? 0 : (index === 1 ? 3 : 6),
              rotationZ: 0,
              rotationY: 0,
              rotationX: 0,
              filter: isFirst 
                ? 'drop-shadow(0 20px 35px rgba(0,0,0,0.65)) brightness(1)' 
                : (index === 1 ? 'drop-shadow(0 14px 25px rgba(0,0,0,0.55)) brightness(0.8)' : 'drop-shadow(0 10px 18px rgba(0,0,0,0.45)) brightness(0.65)'),
              opacity: 1,
        ...
        const distancePerStep = isDesktop ? 800 : 650;
        ...
        if (isDesktop) {
          ...
          // ===================================================================
          // DINÂMICA MOBILE: CARDS INICIAM EMPILHADOS E SAEM PARA CIMA
          // ===================================================================

          // ETAPA 1: Card 0 (Adolescentes) sobe e sai da tela para cima
          tl.to(cards[0], {
            yPercent: -135,
            rotationZ: -3,
            scale: 1.02,
          ...
          // Concomitantemente, Card 1 (Jovens Adultos) sobe para foco pleno no centro
          tl.to(cards[1], {
            yPercent: 0,
            scale: 1,
            filter: 'drop-shadow(0 20px 35px rgba(0,0,0,0.65)) brightness(1)',
          ...
          // Card 2 sobe levemente de fundo para meio
          tl.to(cards[2], {
            yPercent: 3,
            scale: 0.96,
            filter: 'drop-shadow(0 14px 25px rgba(0,0,0,0.55)) brightness(0.8)',
            ease: 'power1.inOut',
            duration: 1
          }, 'step1');

          // ETAPA 2: Card 1 (Jovens Adultos) sobe e sai da tela para cima
          tl.to(cards[1], {
            yPercent: -135,
            rotationZ: 3,
            scale: 1.02,
          ...
          // Concomitantemente, Card 2 (Adultos) atinge o foco pleno no centro
          tl.to(cards[2], {
            yPercent: 0,
            scale: 1,
            filter: 'drop-shadow(0 20px 35px rgba(0,0,0,0.65)) brightness(1)',
